...
final class GamblePokerTest {
    ...
    void specialAbilitiesRequireBothTheHandAndEnoughWeightedScore() {
        ...
        assertEquals(0, flush.debuffCount(299, 15000));
        assertEquals(1, flush.debuffCount(300, 15000));
        assertEquals(0, straight.debuffCount(272, 15000));
        assertEquals(2, straight.debuffCount(273, 15000));
        assertEquals(0, triple.debuffCount(249, 15000));
        assertEquals(3, triple.debuffCount(250, 15000));
        assertEquals(0, GamblePoker.evaluate(12, 25, 28).debuffCount(1000, 15000));
