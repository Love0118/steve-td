...
public final class PirateTowerJob extends SemionJob {
    ...
    public PirateTowerJob() { super(ID, Component.literal("해적 빌더"), List.of(SemionText.mini("<gold>재테크</gold> <gray>준비 시간의 다이아 소비가 제독과 조타수를 강화합니다.</gray>"), SemionText.mini("<aqua>수입</aqua> <gray>갑판원·뱃사공·보물상자로 수익을 순환시킵니다.</gray>"), SemionText.mini("<red>제약</red> <gray>판매 반환은 누적 구매비의 50%이고, 다이아 송금·요청을 할 수 없습니다.</gray>"))); }
