...
public final class PirateTowers {
    ...
    public static final TowerType FERRYMAN = fighter("pirate_ferryman", "뱃사공", 200, 90, 6, 8, 20, 5, player(), abilities("다이아를 얻은 뒤, 추가로 2만큼 얻습니다.", "이 효과로 뱃사공의 효과를 발동시키지 않습니다."));
    public static final TowerType VETERAN_FERRYMAN = fighter("pirate_veteran_ferryman", "노련한 뱃사공", 0, 125, 6, 11, 18, 5, player(), abilities("다이아를 얻은 뒤, 추가로 3만큼 얻습니다.", "이 효과로 뱃사공의 효과를 발동시키지 않습니다."));
    public static final TowerType LEGENDARY_FERRYMAN = fighter("pirate_legendary_ferryman", "전설적인 뱃사공", 0, 165, 6, 15, 17, 5, player(), abilities("다이아를 얻은 뒤, 추가로 4만큼 얻습니다.", "이 효과로 뱃사공의 효과를 발동시키지 않습니다."));
